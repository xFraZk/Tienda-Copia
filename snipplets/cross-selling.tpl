    ...
    {{ component(
        'promotions/cross-selling-form', {
            css_classes: {
                ...
                variant_select_icon_container: 'form-select-icon mr-4',
                add_to_cart_button_container: 'mt-2 mb-1',
                add_to_cart_button: 'btn btn-primary btn-block'
            },
            icon_config: {
                use_svg_icon: false,
                use_custom_icon: true,
                custom_icon_markup: include("snipplets/svg/chevron-down.tpl", { svg_custom_class: "icon-inline icon-lg svg-icon-text d-block" })
            },
            content: {
