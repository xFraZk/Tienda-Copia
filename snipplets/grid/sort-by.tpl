<p class="label-title">{{'Ordenar por:' | translate }}</p>
{% set sort_text = {
'user': 'Destacado',
...
{% embed "snipplets/forms/form-select.tpl" with{select_label: false, select_custom_class: 'js-sort-by mb-4', select_group_custom_class: 'mb-0', select_aria_label: 'Ordenar por:' | translate } %}
